      ...
      >
        <motion.div whileHover={{ scale: 1.05 }}>
          <Button
            ...
            size="icon"
            className="group relative h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 rounded-full border-none 
          ...
          <>
            ...
            <motion.div
              ...
              className="fixed 
                ...
                /* Large desktop */
                xl:w-[450px]
                rounded-2xl overflow-hidden z-50 bg-background border border-border flex flex-col"
            >
              {/* Header */}
